...
public class DaoProduitImpl implements IDaoProduit {
	...
	public List<String> getAllRegionAsString() {
		return em.createQuery(REQ_GETALLREGIONASSTRING, String.class)
				.getResultList();
	}
	...
	public List<Produit> getAllParNom(String paramNom) {
		TypedQuery<Produit> query = em.createQuery(REQ_GETALLPARNOM,
				Produit.class);
	...
	public List<Produit> getAllParNomEnStock(String paramNom) {
		TypedQuery<Produit> query = em.createQuery(REQ_GETALLPARNOMENSTOCK,
				Produit.class);
		query.setParameter(1, "%" + paramNom + "%");
		return query.getResultList();
	}
	...
	public List<Produit> getAllVinParRegion(String paramRegion) {
		return em.createQuery(REQ_GETALLVINPARREGION, Produit.class)
				.setParameter(1, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllVinParRegionEnStock(String paramRegion) {
		return em.createQuery(REQ_GETALLVINPARREGIONENSTOCK, Produit.class)
				.setParameter(1, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllVinParNomEtRegion(String paramNom,
			String paramRegion) {
		return em.createQuery(REQ_GETALLVINPARNOMETREGION, Produit.class)
				.setParameter(1, "%" + paramNom + "%")
				.setParameter(2, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllVinParNomEtRegionEnStock(String paramNom,
			String paramRegion) {
		return em
				.createQuery(REQ_GETALLVINPARNOMETREGIONENSTOCK, Produit.class)
				.setParameter(1, "%" + paramNom + "%")
				.setParameter(2, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllParMillesime(String paramMillesime) {
		return em.createQuery(REQ_GETALLPARMILLESIME, Produit.class)
				.setParameter(1, paramMillesime).getResultList();
	}
	...
	public List<Produit> getAllParMillesimeEnStock(String paramMillesime) {
		List<Produit> listeRetour = em
				.createQuery(REQ_GETALLPARMILLESIMEENSTOCKSPI, Produit.class)
				.setParameter(1, paramMillesime).getResultList();
		listeRetour.addAll(em
				.createQuery(REQ_GETALLPARMILLESIMEENSTOCKVIN, Produit.class)
				.setParameter(1, paramMillesime).getResultList());
		return listeRetour;
	}
	...
	public List<Produit> getAllParMillesimeEtNom(String paramMillesime,
			String paramNom) {
		List<Produit> listeRetour = em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMVIN, Produit.class)
				.setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%").getResultList();
		listeRetour.addAll(em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMSPI, Produit.class)
				.setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%").getResultList());
		return listeRetour;
	}
	...
	public List<Produit> getAllParMillesimeEtNomEnStock(String paramMillesime,
			String paramNom) {
		List<Produit> listeRetour = em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMENSTOCKVIN,
						Produit.class).setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%").getResultList();
		listeRetour.addAll(em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMENSTOCKSPI,
						Produit.class).setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%").getResultList());
		return listeRetour;
	}
	...
	public List<Produit> getAllParMillesimeEtNomEtRegion(String paramMillesime,
		...
		return em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMETREGION, Produit.class)
				.setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%")
				.setParameter(3, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllParMillesimeEtNomEtRegionEnStock(
		...
		return em
				.createQuery(REQ_GETALLPARMILLESIMEETNOMETREGIONENSTOCK,
						Produit.class).setParameter(1, paramMillesime)
				.setParameter(2, "%" + paramNom + "%")
				.setParameter(3, paramRegion).getResultList();
	}
	...
	public List<Produit> getAllVinParMillesimeEtRegion(String paramMillesime,
			String paramRegion) {
		return em.createQuery(REQ_GETALLVINPARMILLESIMEETREGION, Produit.class)
				.setParameter(1, paramMillesime).setParameter(2, paramRegion)
				.getResultList();
	}
	...
	public List<Produit> getAllVinParMillesimeEtRegionEnStock(
		...
		return em
				.createQuery(REQ_GETALLVINPARMILLESIMEETREGIONENSTOCK,
						Produit.class).setParameter(1, paramMillesime)
				.setParameter(2, paramRegion).getResultList();
	}
	...
	@Override
	public List<Produit> getAllProduitByTypeProduit(String paramType,
			boolean enStock) {
	 ...
	 **/
	private final String REQ_GETALLVINETTEXTE = "From Vin v WHERE v.libelle LIKE ?";
	private final String REQ_GETALLSPIRITUEUXETTEXTE = "From Spiritueux s WHERE s.libelle LIKE ?";
	private final String REQ_GETALLACCESSOIREETTEXTE = "From Accessoire a WHERE a.libelle LIKE ?";

	@Override
	public List<Produit> getAllProduitByTypeProduitEtTexte(String paramType,
			String paramText) {
		String requeteFinale = "";
		if (paramType.equals(Vin.class.getSimpleName())) {
			requeteFinale += REQ_GETALLVINETTEXTE;
		} else if (paramType.equals(Spiritueux.class.getSimpleName())) {
			requeteFinale += REQ_GETALLSPIRITUEUXETTEXTE;
		} else if (paramType.equals(Accessoire.class.getSimpleName())) {
			requeteFinale += REQ_GETALLACCESSOIREETTEXTE;
		}
